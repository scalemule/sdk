...
declare class ScaleMuleClient {
    ...
    getActiveAccount(): SessionPoolEntry | null;
    /** Add an account to the session pool and set it as active */
    addAccount(entry: SessionPoolEntry): Promise<void>;
...
declare class AuthService extends ServiceModule {
     ...
     */
    searchUsers(params?: SearchUsersParams, options?: RequestOptions): Promise<ApiResponse<DirectoryUsersListResponse>>;
    /**
     ...
     */
    getUser(userId: string, options?: RequestOptions): Promise<ApiResponse<DirectoryUserDetail>>;
...
declare class StorageService extends ServiceModule {
     ...
     */
    getSettings(options?: RequestOptions): Promise<ApiResponse<StorageSettings>>;
    /**
     * Update the calling app's storage + media settings. Admin-only on the
     * platform side (callers without the right role get 403).
     */
    updateSettings(settings: StorageSettings, options?: RequestOptions): Promise<ApiResponse<StorageSettings>>;
    /**
...
declare class ConferenceService extends ServiceModule {
    protected basePath: string;
    createCall(data: {
        conversation_id?: string;
        call_type?: 'audio' | 'video' | 'screen_share';
        metadata?: Record<string, unknown>;
    }, options?: RequestOptions): Promise<ApiResponse<CallSession>>;
    getCall(callId: string, options?: RequestOptions): Promise<ApiResponse<CallSession>>;
    listCalls(params?: {
        conversation_id?: string;
        status?: string;
        page?: number;
    ...
    endCall(callId: string, options?: RequestOptions): Promise<ApiResponse<CallSession>>;
    joinCall(callId: string, options?: RequestOptions): Promise<ApiResponse<JoinCallResponse>>;
    leaveCall(callId: string, options?: RequestOptions): Promise<ApiResponse<{
        left: boolean;
    }>>;
    listParticipants(callId: string, options?: RequestOptions): Promise<ApiResponse<CallParticipant[]>>;
    startRecording(callId: string, options?: RequestOptions): Promise<ApiResponse<{
        recording_id: string;
        status: string;
    }>>;
    stopRecording(callId: string, options?: RequestOptions): Promise<ApiResponse<{
        recording_id: string;
        status: string;
    }>>;
    consentToRecording(callId: string, options?: RequestOptions): Promise<ApiResponse<{
        granted: boolean;
    }>>;
    getSettings(options?: RequestOptions): Promise<ApiResponse<ConferenceSettings>>;
    updateSettings(data: Partial<ConferenceSettings>, options?: RequestOptions): Promise<ApiResponse<ConferenceSettings>>;
    submitStats(callId: string, stats: WebrtcStats, options?: RequestOptions): Promise<ApiResponse<{
        success: boolean;
    }>>;
}
...
declare class ReferralsService extends ServiceModule {
    protected basePath: string;
    /**
     * Get current user's referral code, share link, campaign, and stats.
     * Requires member auth.
     */
    getMyReferral(options?: RequestOptions): Promise<ApiResponse<ReferralProfile>>;
    /**
     * Generate a tracked share link. The `channel` param records where
     * the share was initiated (e.g., 'whatsapp', 'email', 'copy').
     * Requires member auth.
     */
    createShareLink(channel?: string, options?: RequestOptions): Promise<ApiResponse<ShareLink>>;
    /**
     * Get referral analytics for the current user over the last N days.
     * Requires member auth.
     */
    getMyAnalytics(days?: number, options?: RequestOptions): Promise<ApiResponse<ReferralAnalytics>>;
    /**
     * Resolve a referral code to its campaign info.
     * Public endpoint — no member auth required, only API key.
     */
    resolveCode(code: string, options?: RequestOptions): Promise<ApiResponse<ResolvedReferral>>;
}
...
declare class LeadsService extends ServiceModule {
    protected basePath: string;
    /**
     ...
     */
    create(input: CreateLeadInput, options?: RequestOptions): Promise<ApiResponse<Lead>>;
}
...
declare class NotificationsService extends ServiceModule {
    protected basePath: string;
    /**
     ...
     * ```
     */
    list(params?: ListNotificationsParams, options?: RequestOptions): Promise<ApiResponse<NotificationListResponse>>;
    /**
     ...
     * ```
     */
    unreadCount(options?: RequestOptions): Promise<ApiResponse<UnreadCountResponse>>;
    /**
     * Mark a single notification as read.
     */
    markRead(id: string, options?: RequestOptions): Promise<ApiResponse<void>>;
    /**
     * Mark all notifications as read.
     */
    markAllRead(options?: RequestOptions): Promise<ApiResponse<void>>;
    /**
     * Dismiss a notification (soft delete).
     */
    dismiss(id: string, options?: RequestOptions): Promise<ApiResponse<void>>;
}
...
interface AudioUploadViaStorageResult {
    /** Storage file_id. */
    file_id: string;
...
declare class AudioService extends ServiceModule {
    private readonly storage;
    protected basePath: string;
    /**
     * @param storage Required for {@link uploadViaStorage}. Wired up by the
    ...
    register(args: {
        fileId: string;
        userId?: string;
    }, options?: RequestOptions): Promise<ApiResponse<AudioRegisterResult>>;
    /**
    ...
    uploadViaStorage(file: File | Blob, uploadOptions?: {
        ...
        onProgress?: (progress: number) => void;
        signal?: AbortSignal;
    }, requestOptions?: RequestOptions): Promise<ApiResponse<AudioUploadViaStorageResult>>;
}

type MediaKind = 'image' | 'video' | 'audio' | 'document' | 'other';
type MediaPreset = 'hero' | 'inline' | 'thumbnail' | 'avatar' | 'logo' | 'custom';
type MediaUploadPhase = 'presigning' | 'uploading' | 'scanning' | 'optimizing' | 'ready';
interface MediaUploadEvent {
    phase: MediaUploadPhase;
    progress?: number;
    file_id?: string;
}
interface MediaPresetSpec {
    widths: readonly number[];
    fit?: 'cover' | 'contain';
}
declare const MEDIA_PRESETS: {
    readonly hero: {
        readonly widths: readonly [400, 800, 1200, 1600, 2400];
    };
    readonly inline: {
        readonly widths: readonly [400, 800, 1200];
    };
    readonly thumbnail: {
        readonly widths: readonly [120, 240, 360];
        readonly fit: "cover";
    };
    readonly avatar: {
        readonly widths: readonly [64, 128, 256];
        readonly fit: "cover";
    };
    readonly logo: {
        readonly widths: readonly [120, 240, 480];
    };
};
...
declare class MediaService extends ServiceModule {
    private readonly storage;
    private readonly photo;
    private readonly video;
    private readonly audio;
    protected basePath: string;
    constructor(client: ScaleMuleClient, storage: StorageService, photo: PhotoService, video: VideoService, audio: AudioService);
    getPresets(): Record<Exclude<MediaPreset, 'custom'>, MediaPresetSpec>;
    upload(file: File | Blob, options?: MediaUploadOptions, requestOptions?: RequestOptions): Promise<ApiResponse<MediaUploadResult>>;
    get(fileId: string, options?: MediaManifestOptions, requestOptions?: RequestOptions): Promise<ApiResponse<MediaAsset>>;
    list(params?: PaginationParams & MediaManifestOptions, requestOptions?: RequestOptions): Promise<PaginatedResponse<MediaAsset>>;
    delete(fileId: string, options?: RequestOptions): Promise<ApiResponse<{
        deleted: boolean;
    }>>;
    releaseQuarantine(fileId: string, reason?: string, options?: RequestOptions): Promise<ApiResponse<MediaAsset>>;
...
type TtsSpeechProfile = 'private_default' | 'developer_summary' | 'public_blog' | 'enterprise_strict';
interface TtsAudioInfo {
    id: string;
    status: string;
...
interface TtsSynthesizeQueuedResult {
    status: 'queued';
    job_id: string;
    speech_profile: TtsSpeechMetadata['speech_profile'];
    speech_profile_version: TtsSpeechMetadata['speech_profile_version'];
...
type TtsSynthesizeResult = TtsSynthesizeReadyResult | TtsSynthesizeQueuedResult;
...
interface TtsListVoicesParams {
    provider?: string;
}
declare class TtsService extends ServiceModule {
    protected basePath: string;
    synthesize(params: TtsSynthesizeParams, options?: RequestOptions): Promise<ApiResponse<TtsSynthesizeResult>>;
    getJob(id: string, options?: RequestOptions): Promise<ApiResponse<TtsJobStatus>>;
    listVoices(params?: TtsListVoicesParams, options?: RequestOptions): Promise<ApiResponse<TtsVoicesResponse>>;
}
...
declare class IdentityService extends ServiceModule {
     ...
     */
    identify(anonymousId: string, deviceFingerprintHash?: string, options?: RequestOptions): Promise<ApiResponse<{
        linked: boolean;
        anonymous_id: string;
        message: string;
    }>>;
