...
### Added
- **PollsService** (`sm.polls`): create, publish, read, and vote on reader polls. Questions and choices can carry text, image, video, or audio. `pollVoterKey` stores a device key for public ballots.
