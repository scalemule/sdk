...
export class AgentModelsService extends ServiceModule {
  ...
  async listProviders(
    ...
    options?: RequestOptions
  ): Promise<PaginatedResponse<ModelProvider>> {
  ...
  async listModels(
    params?: PaginationParams & { application_id?: string; provider_id?: string },
    options?: RequestOptions
  ...
  async createPricing(
    modelId: string,
    data: { pricing_type: string; input_cost_per_token?: number; output_cost_per_token?: number },
    options?: RequestOptions
  ...
  async createEntitlement(
    data: { agent_id?: string; model_id: string },
    options?: RequestOptions
  ): Promise<ApiResponse<ModelEntitlement>> {
  ...
  async listEntitlements(
    params?: PaginationParams & { application_id?: string },
    options?: RequestOptions
  ): Promise<PaginatedResponse<ModelEntitlement>> {
  ...
  // Usage & Reporting
  async recordUsage(
    data: { model_id: string; agent_id?: string; input_tokens: number; output_tokens: number; cost_usd?: number },
    options?: RequestOptions
  ...
  async listUsage(
    params?: PaginationParams & { application_id?: string; model_id?: string; agent_id?: string },
    options?: RequestOptions
  ...
  async getCostReport(
    params?: { application_id?: string; days?: number },
    options?: RequestOptions
  ): Promise<ApiResponse<CostReportDay[]>> {
