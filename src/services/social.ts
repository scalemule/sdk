...
export class SocialService extends ServiceModule {
  ...
  async getFollowers(userId: string, params?: PaginationParams, requestOptions?: RequestOptions): Promise<PaginatedResponse<SocialUser>> {
    return this._list<SocialUser>(`/users/${userId}/followers`, params, requestOptions)
  }

  async getFollowing(userId: string, params?: PaginationParams, requestOptions?: RequestOptions): Promise<PaginatedResponse<SocialUser>> {
  ...
  async createPost(data: { content: string; visibility?: string }, options?: RequestOptions): Promise<ApiResponse<SocialPost>> {
  ...
  async getUserPosts(userId: string, params?: PaginationParams, requestOptions?: RequestOptions): Promise<PaginatedResponse<SocialPost>> {
  ...
  async unlike(targetType: string, targetId: string, options?: RequestOptions): Promise<ApiResponse<{ unliked: boolean }>> {
    return this.del<{ unliked: boolean }>(`/${targetType}/${targetId}/like`, options)
  }

  async getLikes(targetType: string, targetId: string, params?: PaginationParams, requestOptions?: RequestOptions): Promise<PaginatedResponse<Like>> {
  ...
  async getComments(postId: string, params?: PaginationParams, requestOptions?: RequestOptions): Promise<PaginatedResponse<Comment>> {
  ...
  async getActivity(params?: PaginationParams, requestOptions?: RequestOptions): Promise<PaginatedResponse<ActivityItem>> {
