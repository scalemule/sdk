...
export class ComplianceService extends ServiceModule {
  ...
  async log(
    data: { action: string; resource_type: string; resource_id: string; metadata?: Record<string, unknown> },
  ...
  async queryAuditLogs(
    params?: { page?: number; per_page?: number; action?: string; resource_type?: string },
  ...
  async createConsentPurpose(
    data: CreateConsentPurposeRequest,
    options?: RequestOptions
  ): Promise<ApiResponse<ConsentPurpose>> {
  ...
  async listDataSubjectRequests(
    params?: { page?: number; per_page?: number; status?: string; request_type?: string },
    requestOptions?: RequestOptions
  ): Promise<ApiResponse<DataSubjectRequest[]>> {
  ...
  async updateDsrStatus(
    id: string,
    data: UpdateDsrStatusRequest,
    options?: RequestOptions
  ): Promise<ApiResponse<DataSubjectRequest>> {
    return this.put<DataSubjectRequest>(`/dsr/${id}/status`, data, options);
  }

  async createDsrAction(
    dsrId: string,
    data: CreateDsrActionRequest,
    options?: RequestOptions
  ): Promise<ApiResponse<DsrAction>> {
  ...
  async listBreaches(
    ...
    requestOptions?: RequestOptions
  ): Promise<ApiResponse<DataBreach[]>> {
  ...
  async createProcessingActivity(
    ...
    options?: RequestOptions
  ): Promise<ApiResponse<ProcessingActivity>> {
  ...
  async updateProcessingActivity(
    id: string,
    data: Partial<CreateProcessingActivityRequest>,
    options?: RequestOptions
  ): Promise<ApiResponse<ProcessingActivity>> {
